...
document.addEventListener('DOMContentLoaded', function(){
    ...
    // el siguiente IF es para validar si existe el objeto $formUsuario, ya que esta funcion tambien
    // es usada desde la vista perfil, modalPerfil y ahi el formulario se llama formModalPerfil, asi
    // que si no existe, no lo ejecuta.
    if(document.querySelector("#formUsuario")){
        ...
        formUsuario.onsubmit = function(e){
            ...
            //let strNombreEmpresa = document.querySelector('#')
                ...
                if(request.readyState == 4 && request.status == 200){
                    ...
                    if(objData.status){
                        if(rowTable == ""){
                            ...
                            //Modifica el html del elemento estado depende del estatus.
                            ...
                            // obtiene el texto (nombre del rol) del elemento seleccionado, ya que es una lista.
                            rowTable.cells[4].textContent = document.querySelector("#listRolid").selectedOptions[0].text;
                            // aplica el html arriba modificado del elemento estado.
                            rowTable.cells[5].textContent = document.querySelector("#listEmpresa").selectedOptions[0].text;;
    ...
    //Actualizar perfil modal perfil de usuario.
...
function fntRolesUsuario(){
    //Igual que como el formulario, si existe este elemento "document.querySelector('#listRolid')"
    // se ejecuta el codigo del elemento.
...
function fntViewUsuario(persona){
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status){
                ...
                document.querySelector("#celEmpresa").innerHTML = objData.data.nombreempresa;
...
function fntEditUsuario(element, persona){     
