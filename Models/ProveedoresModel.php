    ...
    class ProveedoresModel extends Mysql{
        ...
        public function selectProveedores(){
            $sql = "SELECT idpersona, identificacion, nombres, apellidos, telefono, email_user, status
                    FROM persona 
                    WHERE rolid = 10 and status != 0 "; // 10 es rolid de proveedores
            $request = $this->select_all($sql);
            return $request;
        }

        public function selectProveedor(int $idpersona){
            ...
            $sql = "SELECT idpersona, identificacion, nombres, apellidos, telefono, email_user, 
                    ...
                    (select descripcion_uso from cfdi where cfdi.id=persona.usocfdi) as ncfdi 
                           FROM persona   
                           WHERE idpersona = $this->intIdUsuario and rolid = 10";
        ...
        public function deleteProveedor(int $intIdpersona){
